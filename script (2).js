    ...
    function setupNavigation() {
        ...
        navButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                document.querySelector(`.mobile-nav-item[data-page="${targetPage}"]`)?.classList.add('active');
        ...
        mobileNavItems.forEach(item => {
            item.addEventListener('click', (e) => {
                ...
                document.querySelector(`.nav-button[data-page="${targetPage}"]`)?.classList.add('active');
            });
        });
        ...
        // Check for device size and adjust sidebar visibility
